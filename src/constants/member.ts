...
export const memberSchemaData: Schema = [
  ...
  { name: 'memo', label: '메모', uiType: 'textarea', value: 'string', rules: { maxLength: 50 } },
  { name: 'registrationDate', label: '가입일', uiType: 'date', rules: { required: true }, value: 'string' },
  {
    name: 'job',
    label: '직업',
    uiType: 'select',
...
export const MemberInitialData: DataRecord<typeof memberSchemaData>[] = [
  {
    ...
    address: '서울 강남구',
    memo: '외국인',
    registrationDate: dayjs('2024-10-02'),
    job: '개발자',
  ...
  },
  {
    ...
    address: '서울 서초구',
    memo: '한국인',
    registrationDate: dayjs('2024-10-01'),
    job: 'PO',
